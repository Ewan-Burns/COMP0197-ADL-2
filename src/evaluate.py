...
from src.baseline.unet import UNet
...
def evaluate(model, dataloader, device, num_classes):
    ...
    with torch.no_grad():
        ...
        for images, masks in bar:
            ...
            if isinstance(model, (UNet, MultiHeadResNet)):
                 # UNet output: (N, C, H, W)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model-type', type=str, required=True, choices=['unet', 'deeplabv3', 'resnet_sec'],
